...
if __name__ == "__main__":
    ...
    chunk("D:\\EngRAG\\LiteratureIsEasy\\knowledge_base\\ANHTC 1-2\\Tactics for TOEIC (Speaking and Writing)\\Sample_tests.pdf", from_page=0, to_page=100000, lang="English", callback=dummy)
